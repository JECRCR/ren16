        ...
        .state('team', {
            ...
            controller: function($scope, $state, Page) {
                var memberCategories = {
                    ...
                    '1': [{
                        n: 'Akshara Parnami',
                        m: 'aksharaparnami1995@gmail.com',
                        img: 'akshara.jpg',
                        p: '+91-8824301223'
                    }, {
                        n: 'Anish Jain',
                        m: 'anishjain99@gmail.com',
                        img: 'anish.jpg',
                        p: '+91-9782606370'
                    }],
                    '2': [{
                        n: 'Lokesh Devnani',
                        m: 'contact@lokeshd.com',
                        img: 'lokesh.jpg',
                        p: '+91-8946936804',
                        site: 'www.lokeshd.com'
                    }, {
                        'n': 'Udit Vasu',
                        m: 'uditvasu.cse17@jecrc.ac.in',
                        img: 'udit.jpg',
                        p: '+91-9928599390',
                        site: 'www.uditvasu.net'
                    }],
                    '3': [{
                        n: 'Rajdeep Gautam',
                        m: 'i@rajdeepgautam.com',
                        img: 'rajdeep.jpg',
                        site: 'www.rajdeepgautam.com'
                    }, {
                        n: 'Raghav Pareek',
                        m: 'designflames@gmail.com',
                        img: 'raghav.jpg'
                    }],
                    '4': [{
                        n: 'Kavish Goyal',
                        m: 'kavish.goyal@live.com',
                        img: 'kavish.jpg',
                        p: '+91-8302355577'
                    }, {
                        n: 'Shaheen Khan',
                        m: 'shaheen14@ymail.com',
                        img: 'shaheen.jpg',
                        p: '+91-8003403634'
                    }],
                    '5': [{
                        n: 'Anand Mott',
                        m: 'anandmott@gmail.com',
                        img: 'anand.jpg',
                        p: '+91-9782113840'
                    }, {
                        n: 'Deeksha Sharma',
                        m: 'dsmissadorable@gmail.com',
                        img: 'deeksha.jpg',
                        p: '+91-7742039889'
                    }]
                };
        ...
        .state('events.splash', {
            ...
            controller: function(renService, $scope, $state) {
                ...
                $scope.openDetails = function(eventTitle) {
                    $state.go('events.' + $scope.category + '.eventId', {
                        id: eventTitle
                    });
                }
            }
...
renApp.factory('Page', function($window) {
    ...
    return {
        ...
        setTitle: function(newTitle) {
            title = newTitle;
            $window.document.title = 'JECRC Renaissance 2016 | ' + newTitle;
        }
    };
});
